 ...
 */
extern DLLEXPORT int Imagescale_Init(Tcl_Interp * interp);
 ...
 * 
 * Code taken from http://wiki.tcl.tk/25685
 *
...
int Imagescale_Init(Tcl_Interp *interp)
{
  /*
   * This requires Tcl/Tk version 8.5 or greater
   */
